...
import static com.example.market_app.ItemFragment.DATEPICKER_FRAGMENT;
import static com.serenegiant.utils.UIThreadHelper.runOnUiThread;

public class QRScanDialogFragment extends BaseActivity implements CameraDialog.CameraDialogParent {

    private static final boolean DEBUG = true;	// TODO set false on release
    private static final String TAG = "QRtest_MainActivity";
...
//    private TextView mFpsTv;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_qr_scan_dialog);
...
//        mCaptureButton.setVisibility(View.INVISIBLE);
        ...
        View rootView = mUVCCameraView.getRootView();
        rootView.setBackgroundColor(getResources().getColor(R.color.darkpink));
...
//        mFpsTv.setTypeface(Typeface.MONOSPACE);
    ...
    protected void onStop() {
        ...
        //qrcode_Handler.removeCallbacks(runnable);
        super.onStop();
    }
...
//                        CameraDialog.showDialog(QRScanDialogFragment.this);
//                    } else {
//                        stopPreview();
//                    }
//                    break;
...
//                    mCaptureButton.setVisibility(View.VISIBLE);
    ...
    private final OnDeviceConnectListener mOnDeviceConnectListener
        ...
        public void onAttach(final UsbDevice device) {
            Toast.makeText(QRScanDialogFragment.this,
        ...
        public void onConnect(final UsbDevice device,
            ...
            startPreview();
            updateItems();
            //qrcode_Handler.postDelayed(runnable, 2000);
        }
...
//                    ViewAnimationHelper.fadeIn(mValueLayout, -1, 0, mViewAnimationListener);
    ...
    Handler qrcode_Handler=new Handler();
    ...
    Runnable runnable=new Runnable() {
        ...
        public void run() {
            try{
                ...
                qrcode_Handler.postDelayed( this,1100);
            }catch (Exception e){
                e.printStackTrace();
            }
        }
    ...
    private void scan_qrcode(){
        ...
        String pathToPicture = "test";
        //Bitmap bMap = BitmapFactory.decodeFile(pathToPicture);
        String contents = null;

        File rootsd = Environment.getExternalStorageDirectory();
        //File imgFile = new File(rootsd.getAbsolutePath() + "/DCIM/USBCameraTest/2019-12-30-19-46-45.png");

        File dir = new File(rootsd.getAbsolutePath() + "/DCIM/USBCameraTest/");
        ...
        //File rootsd = Environment.getExternalStorageDirectory();
        //File imgFile = new File(rootsd.getAbsolutePath() + "/DCIM/USBCameraTest/2019-12-30-19-46-45.png");
        //File imgFile = new  File("/DCIM/USBCameraTest/2019-12-30-18-52-54.png");
        Bitmap bMap = BitmapFactory.decodeFile(lastModifiedFile.getAbsolutePath());

        int[] intArray = new int[bMap.getWidth()*bMap.getHeight()];
        Log.d("width:",String.valueOf(bMap.getWidth()));
        ...
        if(result!=null){
            ...
            try{
                // delay 1 second
                Thread.sleep(500);
                if (DEBUG) Log.v(TAG, "thread sleep 500ms");

            } catch(InterruptedException e){
                e.printStackTrace();
            }
            QRScanDialogFragment.this.setResult(RESULT_OK, intent);
            QRScanDialogFragment.this.finish();
            //onDestroy();
    ...
    public void createItemInfoDialog(String url, String title , String describe, int location){
        ...
        //dialog.show(this.getFragmentManager(), "MyProgressDialog");
    }
...
//            mFpsTv.setText(String.format(Locale.US, "FPS:%4.1f->%4.1f", srcFps, resultFps));
    ...
    protected class MyImageProcessorCallback implements ImageProcessor.ImageProcessorCallback {
        ...
        public void onFrame(final ByteBuffer frame) {
            if (DEBUG) Log.v(TAG, "onFrame");
            if (mResultView != null) {
                if (DEBUG) Log.v(TAG, "onFrame1");
...
//--------------------------------------------------------------------------------
                ...
                if (DEBUG) Log.v(TAG, "onFrame3");

                try {
                    frame.clear();
                    mFrame.copyPixelsFromBuffer(frame);
                    scan_qrcode_preview(mFrame);
        ...
        private void scan_qrcode_preview(Bitmap bMap){
            //Bitmap bMap = [...];
